...
import structureDesktop from "figma:asset/a20465e432effb58f36afdd18cfea22537f2413e.png";
import structureMobile from "figma:asset/406c63a7e00116c5dcbea036e7baf8e3293f1567.png";
import faviconImg from "figma:asset/1f15a2086f5250039ebaf8d6b07263b3529955f4.png";
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // Set page title
    document.title = "EvolveIQ | Digital Infrastructure";
    ...
    <div className="min-h-screen w-full bg-[#080808] text-[#Eaeaea] font-sans overflow-x-hidden cursor-none selection:bg-[#FF4500] selection:text-black">
      ...
      <div className="relative max-w-[1300px] mx-auto px-6 md:px-12 border-l border-r border-[#1f1f1f] min-h-screen bg-[#080808]/70 backdrop-blur-[5px]">
        ...
        <header className="sticky top-0 z-50 flex justify-between items-center py-8 border-b border-[#1f1f1f] bg-[#080808] backdrop-blur-md">
          ...
          >
            Evolve<span className="bg-[#FF4500] text-black px-2 py-0.5">IQ</span>
          </a>
            ...
            <div className="border-l-2 border-[#FF4500] pl-6 opacity-90 flex flex-col justify-between h-full">
              <div>
                <p className="text-[#ccc] text-xl md:text-2xl leading-relaxed mb-12">
                  EvolveIQ is a tactical design squad. We build landing pages and web apps engineered for revenue. <br/><br/>
      ...
      <div className="relative max-w-[1300px] mx-auto px-6 md:px-12 border-l border-r border-[#1f1f1f] bg-[#080808]/70 backdrop-blur-[5px]">
        ...
        <section id="work" className="py-24">
          ...
          <div className="grid grid-cols-1 gap-12 mt-12">
            ...
            {/* Project 3: Structure AI Trading Platform */}
            <article 
              className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] border border-[#1f1f1f] bg-[#0a0a0a] transition-all duration-300 hover:bg-[#111] group"
              onMouseEnter={onHoverStart}
              onMouseLeave={onHoverEnd}
            >
              ...
              >
                ...
                <div className="hidden lg:block absolute top-0 left-0 w-[100%] h-full z-0 transform transition-transform duration-700 group-hover:scale-[1.02]">
                    <div className="absolute inset-0 bg-black/40 backdrop-blur-[1px] z-10"></div> 
                    <img 
                        src={structureDesktop} 
                        alt="Structure Desktop" 
                        className="w-full h-full object-cover object-left-top opacity-70"
                    />
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="w-full h-full bg-white relative flex flex-col overflow-hidden">
                            <img 
                              src={structureMobile} 
                              alt="Structure Mobile Interface" 
                              className="w-full h-full object-cover"
                            />
                            {/* Tap Overlay */}
                            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors pointer-events-none"></div>
                ...
                <div className="mt-6 font-mono text-[10px] text-emerald-500 uppercase tracking-widest group-hover:text-emerald-400 transition-colors lg:hidden">
                    [ AI-POWERED ANALYTICS ]
                </div>
              </div>

              <div className="p-8 flex flex-col justify-center relative z-10 bg-[#0a0a0a] lg:bg-transparent">
                <span className="font-mono text-xs text-[#666] mb-6 block">/// SECTOR: FINTECH</span>
                <h3 className="font-oswald text-3xl mb-4 text-[#FF4500]">STRUCTURE TRADING PLATFORM</h3>
                <p className="text-[#ccc] mb-6 text-[0.95rem] leading-relaxed">
                  Built a high-performance SaaS platform for AI-driven stock analysis and trading signals. Real-time neural engine integration with professional-grade dashboards designed for institutional traders and serious retail investors.
                </p>
                <div className="font-oswald text-5xl text-[#FF4500] leading-none mb-2">$2.4M</div>
                <div className="font-mono text-xs text-[#666]">SEED FUNDING SECURED</div>
              </div>
            </article>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article className="border border-[#1f1f1f] p-8 bg-[#0a0a0a] hover:border-[#FF4500] transition-colors duration-300">
              ...
              <p className="text-[#ccc] text-lg leading-relaxed mb-6 font-inter">
                EvolveIQ didn't just build a website. They built a war machine. Our lead volume tripled in the first week of deployment. The 7-day timeline wasn't a marketing gimmick; it was a promise kept.
              </p>
            ...
            <article className="border border-[#1f1f1f] p-8 bg-[#0a0a0a] hover:border-[#FF4500] transition-colors duration-300">
              <div className="text-[#FF4500] text-4xl font-oswald mb-4">"</div>
              <p className="text-[#ccc] text-lg leading-relaxed mb-6 font-inter">
                Our Instagram was incredible, but our website was a letdown. EvolveIQ built a bold, modern platform that finally does our work justice. It captures the exact vibe we were missing.
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#222] rounded-full overflow-hidden">
            ...
            {/* Testimonial 3: Structure */}
            <article className="border border-[#1f1f1f] p-8 bg-[#0a0a0a] hover:border-[#FF4500] transition-colors duration-300">
              <div className="text-[#FF4500] text-4xl font-oswald mb-4">"</div>
              <p className="text-[#ccc] text-lg leading-relaxed mb-6 font-inter">
                We needed a platform that could handle real-time data at scale and look premium doing it. EvolveIQ delivered a SaaS product that impressed our seed investors and converted beta users at 47%. Absolute precision.
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#222] rounded-full overflow-hidden">
                   <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="Client" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h4 className="font-oswald text-white">ALEX CHEN</h4>
                  <p className="font-mono text-xs text-[#666]">CTO, STRUCTURE AI</p>
                </div>
              </div>
            </article>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="font-oswald leading-none mb-1 flex items-baseline">
                <span className="text-4xl text-[#FF4500]">CONTACT FOR QUOTE</span>
              </div>
              <p className="font-mono text-xs opacity-60 mb-6">CUSTOM PRICING</p>
